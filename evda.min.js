function EvDa(p){function m(a,b,c){d[a]=b;h([i,n],function(d){h(q(f[d+a]),function(a){a(b,c);a.X&&o(a)})})}function r(a,b,c){function d(e){g+=e===!1;--i||g||m(a,b,c)}var e=j+a,i=k(f[e]),g=0;h(f[e],function(a){a(b,l(c,{done:d}))})}function o(a){h(a.$,function(b){f[b]=_.without(f[b],a)})}function e(a,b,c){return k(arguments)==1?_.isObject(a)?(h(a,function(b,d){a[d]=e(d,b,c)}),a):d[a]:e[_.isFunction(b)?i:"set"](a,b,c)}var h=_.each,l=_.extend,k=_.size,q=_.clone,j="test",i="on",n="after",d=p||{},g={},
