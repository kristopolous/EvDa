...
key:a,deregister:function(){m(e)}})})}function y(a){a.refList=[];q[a.ix=++z]=a}function k(a,g,b){var d={};i(r([a]),function(a){var f;l[a]||(l[a]=!0,f=h.test[a]?x(a,g,b):p(a,g,b));d[a]=f});return d}function m(a){i(a.refList,function(b){var c=b[0],b=b[1];h[c][b]=_.without(h[c][b],a)});delete q[a.ix]}function s(a){var b={};a.scope=a.scope?[a.scope]:[];a.meta=a.meta||[];i(t(j),function(c){b[c]=function(){j[c].apply(this,a.scope.concat(n.call(arguments),a.meta));return b}});return b}var f={},i=_.each,
