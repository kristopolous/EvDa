...
callback:j,key:a,deregister:function(){n(f)}})})}function y(a){a.ix=++z;a.refList=[];return r[a.ix]=a}function k(a,e,c){var b={};s(a)&&(a=[a]);g(a,function(a){var d;l[a]||(l[a]=!0,d=h.test[a]?x(a,e,c):q(a,e,c));b[a]=d});return b}function n(a){a.refList&&g(a.refList,function(e){var b=e[0],e=e[1],j=_.indexOf(h[b][e],a);h[b][e].splice(j,1)});delete r[a.ix]}function t(a){var b={};a.scope=a.scope?[a.scope]:[];if(!a.meta)a.meta=[];g(u(d),function(c){b[c]=function(){d[c].apply(this,a.scope.concat(o.call(arguments),
a.meta));return b}});return b}var i={},g=_.each,u=_.keys,p=_.extend,v=_.isFunction,m=_.isArray,s=_.isString,A=_.isNumber,o=Array.prototype.slice,b={},z=0,r={},h={},l={},d={},d={push:function(a,e){m(b[a])||(b[a]=[]);b[a].current=b[a].push(e);return k(a,b[a])},pop:function(a){if(m(b[a]))return b[a].pop(),b[a].current=_.last(b[a]),k(a,b[a])},onSet:function(a,b){return d.invoke(a,b).handle},decr:function(a){return k(a,b[a]-1||0)},incr:function(a){return k(a,A(b[a])?b[a]+1:1)},notNull:function(a,e){if(a in
