...
b[a])},once:function(a,b){var d=e.when(a,b);d.handle.rm=!0;return d},decr:function(a){return j(a,b[a]-1||0)},incr:function(a){return j(a,_.isNumber(b[a])?b[a]+1:1)},isset:function(a,c){if(!(a in b)&&c)return e.once(a,c);c&&c(b[a]);return a in b},whenset:isset,onset:get,run:j,emit:j,get:e,set:function(a,b){arguments.length==1&&(b=!0);return e(a,b)},unset:function(a){delete b[a]},remove:m})};
