...
b[a])},once:function(a,b){var d=e.when(a,b);d.handle.rm=!0;return d},decr:function(a){return j(a,b[a]-1||0)},incr:function(a){return j(a,_.isNumber(b[a])?b[a]+1:1)},exists:function(a,c){if(!(a in b))return e.once(a,c);c(b[a])},run:j,get:e,set:function(a,b){arguments.length==1&&(b=!0);return e(a,b)},remove:m})};
