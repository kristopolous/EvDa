...
(k[a]=!0,f[a]=i.test[a]?s(a,c,b):n(a,c,b))});return f}function m(a){h(a.refs,function(c){var b=c[0],c=c[1];i[b][c]=_.without(i[b][c],a)});delete o[a.ix]}function v(a){var b={};a.scope=a.scope?[a.scope]:[];a.meta=a.meta||[];h(q(e),function(d){b[d]=function(){e[d].apply(this,a.scope.concat(_.toArray(arguments),a.meta));return b}});return b}function e(a,c){var d=arguments.length,f={};if(d==0)return[b,i];if(_.isObject(a))return h(a,function(a,b){f[b]=e(b,a)}),f;if(d==1)return a.search(/[*?]/)+1?_.select(q(b),
...
b[a])},once:function(a,b){var d=e.when(a,b);d.handle.rm=!0;return d},decr:function(a){return j(a,b[a]-1||0)},incr:function(a){return j(a,_.isNumber(b[a])?b[a]+1:1)},exists:function(a,c){if(!(a in b))return e.once(a,c);c(b[a])},run:j,get:e,set:e,remove:m})};
