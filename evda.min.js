...
unset:function(a){delete c[a]},del:l,isset:i,setter:function(a,b){f[a]=b;d["on"+a]&&i(a)},set:function(a,b,f,i){var h="test"+a,m=k(d[h]),n,o={meta:f||{},old:c[a],key:a,done:function(c){n|=c===!1;--m||n||e.set(a,b,f,1)}};m&&!i?g(d[h],function(a){a(b,o)}):(c[a]=b,g((d[j+a]||[]).concat(d["after"+a]||[]),function(a){a.S||(a(b,o),a.once&&l(a))}));return b}})};
