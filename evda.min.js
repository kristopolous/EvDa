function EvDa(A){function c(a,b,q){if(l(a))return B(a,function(a){return c.call(c.context,a,b,q)});if(1==arguments.length){if(v(a)){var f={};e(a,function(a,b){f[a]=c(a,b,q,0,1)});e(f,function(b,q){m(f[b])&&!m(a[b])&&(a[b]=f[b]())});return a}return d[a]}return c[m(b)?t:"set"].apply(this,arguments)}function y(a){e(a.$,function(b){g[b]=z(g[b],a)})}function n(a,b){if(l(a))return n(a.pop(),n(1==a.length?a[0]:a,b));if(v(a))return e(a,function(b,c){a[b]=n(b,c)}),a;k[a]&&(k[a](function(b){c.set.call(c.context,
