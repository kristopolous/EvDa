function EvDa(p){function k(a){h(a.$,function(b){c[b]=_.without(c[b],a)})}function f(a,b,d){return l(arguments)==1?_.isObject(a)?(h(a,function(b,c){a[c]=f(c,b,d)}),a):e[a]:f[_.isFunction(b)?j:"set"](a,b,d)}var h=_.each,i=_.extend,l=_.size,j="on",e=p||{},g={},c={};h([j,"after","test"],function(a){f[a]=function(b,d){(d.$||(d.$=[])).push(a+b);(c[a+b]||(c[a+b]=[])).push(d);return d}});return i(f,{data:e,events:c,once:function(a,b){return i(f(a,b),{X:1})},setter:function(a,b){g[a]=b;a in e&&f.isset(a)},
